...
const Jobs = () => {
    ...
    const jobs = [
        {
          ...
          description:
            "We are looking for a skilled Software Engineer to join our team. Experience in React and Node.js is a plus.",
        },
        {
          id: 2,
          ...
          description:
            "Join our creative team as a UI/UX Designer. Knowledge of Figma and Adobe XD is required.",
        },
        {
          id: 3,
          title: "Data Analyst",
          ...
          description:
            "Seeking a detail-oriented Data Analyst to work on big data projects. SQL and Python skills are essential.",
        },
        {
            id: 4,
            title: "Software Engineer",
  ...
  {jobs.map((job) => (
    <div
      key={job.id}
      className="bg-gradient-to-r from-gray-50 via-white to-gray-100 shadow-md rounded-lg p-6 flex flex-col justify-between hover:shadow-2xl transition-shadow duration-300"
    >
      {/* Job Title */}
      ...
      {/* Job Location */}
      <p className="text-gray-500 text-sm mb-6 italic flex items-center">
        <svg
      ...
      {/* Apply Button */}
      <button className="mt-auto bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-base font-medium py-2 px-4 rounded-md shadow-md hover:from-blue-600 hover:to-indigo-700 transition-transform transform hover:scale-105">
        Apply Now
      </button>
    </div>
  ))}
