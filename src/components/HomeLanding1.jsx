    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl py-10 font-bold text-orange-500 mb-8 text-left">
            It's Time to Build
          </h1>
          ...
          <p className="text-xl md:text-2xl leading-relaxed text-gray-700 text-left">
            ...
            in seed to venture to{" "}
            <span className="bg-blue-100 px-1">growth-stage technology</span>{" "}
            companies, across <span className="bg-blue-100 px-1">AI</span>,{" "}
            <span className="bg-blue-100 px-1">bio + healthcare</span>,{" "}
            <span className="bg-blue-100 px-1">consumer</span>,{" "}
            <span className="bg-blue-100 px-1">crypto</span>,{" "}
            <span className="bg-blue-100 px-1">enterprise</span>,{" "}
            <span className="bg-blue-100 px-1">fintech</span>,{" "}
            <span className="bg-blue-100 px-1">games</span>,{" "}
            <span className="bg-blue-100 px-1">infrastructure</span>, and
            companies building toward{" "}
            <span className="bg-blue-100 px-1">American dynamism</span>. a16z
            has $44B in committed capital across multiple funds.
          </p>

          <p className="text-xl md:text-2xl leading-relaxed text-gray-700 text-left mt-8">
            Respect for the entrepreneur and the company-building process{" "}
            <span className="bg-blue-100 px-1">defines a16z</span>. We know what
            it's like to be in the founder's shoes. General partners lead the
            firm, many of whom are former founders/operators, CEOs, or CTOs of
